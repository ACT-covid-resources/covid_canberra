...
This constitues one of the challenges that is unique to a small collection of areas which are small and surrounded by much larger states and districts.

### Levels of possible grouping{.tabset .tabpills}

The raw data has the following location varibles of interest:
