...
library(crosstalk)
#latest dataset
tab3 <- read.csv(here::here("data/last.csv"))
# Aggregate method
...
busses <- readOGR(dsn = here::here("bus"), layer = "geo_export_69c76e06-1d3f-4619-be3b-b4e5789be8ca", verbose = TRUE)
...
m <- m %>% addCircleMarkers(lat=tab3$, lng=tab3$lon,popup = labs, weight=nn2, fillColor = cols[cc],color=ncols[nn], opacity =0.8, radius = 5 , fillOpacity = 0.8)
